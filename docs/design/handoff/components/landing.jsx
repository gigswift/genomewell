...
const GWLanding = ({ surface = 'mobile', heroVariant = 'a', onUpload }) => {
  ...
  return (
    <div style={{
          ...
          {[
            ...
            <div key={item.n} style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              <span style={{
                ...
                letterSpacing: '0.12em', color: 'var(--gw-inkSoft)',
              }}>{item.n}</span>
              <h4 style={{
              ...
              <p style={{
                ...
                color: 'var(--gw-inkMuted)', textWrap: 'pretty',
              }}>{item.d}</p>
            </div>
          ))}
        </div>
      ...
      <footer style={{
        ...
        gap: 12, color: 'var(--gw-inkSoft)',
        fontFamily: 'var(--gw-font-mono)', fontSize: 11,
        letterSpacing: '0.06em', textTransform: 'uppercase',
      }}>
        <span>© 2026 Genomewell · Evidence notes · Privacy</span>
...
const HeroEditorial = ({ surface }) => (
  <section style={{
    ...
    <div style={{
      ...
      color: 'var(--gw-inkSoft)', marginBottom: surface === 'mobile' ? 20 : 28,
    ...
    <h1 style={{
      ...
      Your DNA,<br/>
      <em style={{ fontStyle: 'italic', color: 'var(--gw-accent)' }}>read on your phone.</em><br/>
      Not on our server.
    </h1>
    <p style={{
      ...
      lineHeight: 1.5, color: 'var(--gw-inkMuted)',
      textWrap: 'pretty',
    }}>
      Drop in your raw 23andMe or Ancestry file. We'll map your variants to specific supplements — dose, reasoning, and where to buy them, if anywhere. <strong style={{ color: 'var(--gw-ink)', fontWeight: 500 }}>The file never leaves this tab.</strong>
    </p>
  </section>
);
...
const HeroStatement = ({ surface }) => (
  <section style={{
    ...
    <h1 style={{
      ...
      Wellness that<br/>
      actually reads<br/>
      <span style={{ color: 'var(--gw-accent)' }}>your genes.</span>
    </h1>
  </section>
);
      ...
      {!active && !done && (
        <>
          <div>
            ...
            <div style={{ fontSize: 13, color: 'var(--gw-inkMuted)' }}>
              .txt or .zip from 23andMe or AncestryDNA · up to 30 MB
            </div>
          </div>
          <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', justifyContent: 'center' }}>
            <GWButton variant="primary" onClick={onBrowse}>Choose a file</GWButton>
            <GWButton variant="ghost" onClick={onBrowse}>Try a demo file</GWButton>
          </div>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <svg width="24" height="28" viewBox="0 0 24 28" fill="none">
          ...
          {done && <path d="M8 18 L11 21 L16 15" stroke="var(--gw-accent)" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"/>}
        </svg>
      </div>
    </div>
  );
...
Object.assign(window, { GWLanding, HeroEditorial, HeroStatement, HeroSplit, UploadZone, LockRing });
